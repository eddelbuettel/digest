...
stopifnot(sha1(sum) == "098c0ebd5df77c19684f3f8c9aefc3ca810a159b")
stopifnot(sha1(sum) == sha1(sum, environment = TRUE))
stopifnot(sha1(sum) != sha1(sum, environment = FALSE))

stopifnot(sha1(glm) == "37d3e95bb1da86f0d1316acf655d12bb50288a20")
stopifnot(sha1(glm) == sha1(glm, environment = TRUE))
stopifnot(sha1(glm) != sha1(glm, environment = FALSE))
